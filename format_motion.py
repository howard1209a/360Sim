...
for user_index in range(1, 21):
    # 读取 CSV 文件
    input_path = os.path.join(r"D:\codes\360Sim\source\motion_trace\paper\v1_video_13_vr_data_20220525T201707.csv")
    ...
    # 输出TXT文件
    txt_output_path = os.path.join(r"D:\codes\360Sim\source\motion_trace\paper\video_9_u3.txt")
