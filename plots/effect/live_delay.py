...
if __name__ == "__main__":
    ['SPB-360', 'Vaser', 'VAAC', 'VAAC-E', 'PW', 'BCD']

    SPB360_live_delay_list = [x / 1000.0 for x in pd.read_csv("../raw_data/record/SPB-360_record.csv")['latency'].tolist()]
    ...
    VAAC_E_live_delay_list = [x / 1000.0 for x in pd.read_csv("../raw_data/record/VAAC-E_record.csv")['latency'].tolist()]
