...
from strategy.SPB360_strategy import SPB360Strategy
...
class NetSim():
    ...
    def load_agent(self):
        ...
        if abr_strategy == "LB":
            self.agent = LBStrategy()
        elif abr_strategy == "Vaser":
            self.agent = VaserStrategy()
        elif abr_strategy == "VAAC":
            self.agent = VAACStrategy()
        elif abr_strategy == "VAAC-E":
            self.agent = VAACEStrategy()
        elif abr_strategy == "PW":
            self.agent = PWStrategy()
        elif abr_strategy == "BCD":
            self.agent = BCDStrategy()
        elif abr_strategy == "SPB-360":
            self.agent = SPB360Strategy()
